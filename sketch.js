...
var nameBox, Name, startB;
var collideS, enterS, loseS, blastS
...
function preload() {
  ...
  collideS = loadSound("collide.mp3")
  enterS = loadSound("entry.mp3")
  loseS = loadSound("end.mp3")
  blastS = loadSound("blast.mp3")
}
...
function setup() {
  ...
  replay.position(150,400);
  replay.hide();
  replay.style('color', 'black')
  replay.mousePressed(ResetF)
